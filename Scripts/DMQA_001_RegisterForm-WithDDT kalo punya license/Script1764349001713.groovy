...
WebUI.setText(findTestObject('Object Repository/Register_Form_Object/input_Name_firstName'), firstName)

WebUI.setText(findTestObject('Object Repository/Register_Form_Object/input_Name_lastName'), lastName)

WebUI.setText(findTestObject('Object Repository/Register_Form_Object/input_Email_userEmail'), email)

WebUI.click(findTestObject('Object Repository/Register_Form_Object/Gender_Male'))

WebUI.setText(findTestObject('Object Repository/Register_Form_Object/Field Number'), Number)
...
WebUI.setText(findTestObject('Object Repository/Register_Form_Object/Input_Current Address'), address)
...
WebUI.verifyElementText(findTestObject('Register_Form_Object/Succes Thanks Submit'), 'Thanks for submitting the form')
